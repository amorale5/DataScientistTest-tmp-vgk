"""Agrega tablas de deciles e histogramas de score al JSON de reporte de la Ronda 4."""
import json
import numpy as np
import pandas as pd
...
def decile_table(y, score):
    ...
    return g.sort_values("decile", ascending=False).to_dict("records")
...
def main():
    ...
    del d["score_valid_logit"]; del d["score_valid_lgbm"]
    del d["score_test_logit"]; del d["score_test_lgbm"]
